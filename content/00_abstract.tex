...
Aus den Formfaktoren wird die differentielle Zerfallsbreite des Zerfalles und hieraus die Observable $R(D)$ zu $\input{pycode/R_si33.tex}$ bestimmt, wobei sich eine Abweichung von $\input{pycode/R_abweichung_33.tex}\sigma$ zu den experimentellen Werten von Belle und BaBar ergibt.
