...
\begin{align*}
  S = \sum_{i=0}^{} \left( y_{i,+}(z_i) - f_{+}(z_i, \overrightarrow{a_+}) \right)^2 + \sum_{i=0}^{} \left( y_{i,0}(z_i) - f_{0}(z_i, \overrightarrow{a_0}) \right)^2
\end{align*}
durch die passende Wahl der Fitparameter $\overrightarrow{a_+}$ und $\overrightarrow{a_0}$ zu minimieren.
...
\begin{align*}
  S = \overrightarrow{r}^T \, \symbf{W} \, \overrightarrow{r},
\end{align*}
minimiert, wobei $\overrightarrow{r}$ als Vektorkomponenten die einzelnen Residuen $y_i - f(z_i)$ beinhaltet und $\symbf{W}$ die Gewichtsmatrix ist.
...
\begin{equation}
  \label{eqn:apg}
  \chi^2 = \sum_{i=0}^{} \left( \frac{y_{i,+}(z_i) - f_{+}(z_i, \overrightarrow{a_+})}{\sigma_{y_{i,+}}} \right)^2 + \sum_{i=0}^{} \left( \frac{y_{i,0}(z_i) - f_{0}(z_i, \overrightarrow{a_0})}{\sigma_{y_{i,0}}}  \right)^2
\end{equation}
