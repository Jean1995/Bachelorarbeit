...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{pycode/plot_21.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{pycode/plot_12.pdf}
  \caption{Fit an die Theoriewerte für $N_0 = \num{1}$ und $N_+ = \num{2}$.}
  \label{fig:fit12}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{pycode/plot_22.pdf}
  \caption{Fit an die Theoriewerte für $N_0 = \num{2}$ und $N_+ = \num{2}$.}
  \label{fig:fit22}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.6\textwidth]{pycode/plot_33.pdf}
  \caption{Fit an die Theoriewerte für $N_0 = \num{3}$ und $N_+ = \num{3}$.}
  \label{fig:fit33}
\end{figure}
