...
Um ein Konfidenzintervall für die gefittete Funktion zu bestimmen, werden $\input{pycode/samples.tex}$ verschiedene Konfigurationen der fehlerbehafteten Eingangsdaten und Fitparameter zufallsgeneriert, wobei alle Daten als normalverteilt angenommen werden.
